...
# this code is to analysis the genetic variants effect on DNA methylation.
# step 1, bin the genetic variants
# Calculate the methylation and depth in genetic variants regions
